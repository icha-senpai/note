...
func (repo *Repo) uploadCloudMissingObjects(_ *TrafficStat, _ map[string]interface{}) {
	// Official-cloud object repair has been removed from Scribli. User-controlled
	// providers do not publish or consume the check/indexes-report object.
	return
}

func (repo *Repo) updateCloudCheckIndex(_ *entity.CheckIndex, _ map[string]interface{}) (err error) {
	return
}
