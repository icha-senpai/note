...
import (
	...
	asSigner "github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/aws/signer/v4"
	...
	as3 "github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/s3"
	as3Types "github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/s3/types"
...
func (s3 *S3) GetIndexes(page int) (ret []*entity.Index, pageCount, totalCount int, err error) {
	...
	for i := start; i < end; i++ {
		...
		index.Files = nil // Optimize the performance of obtaining cloud snapshots
