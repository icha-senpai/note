...
<br><br>
<a title="Build Status" target="_blank" href="https://github.com/icha-senpai/note/third_party/forks/lute/actions/workflows/gotest.yml"><img src="https://img.shields.io/github/actions/workflow/status/88250/lute/gotest.yml?style=flat-square"></a>
<a title="Go Report Card" target="_blank" href="https://goreportcard.com/report/github.com/icha-senpai/note/third_party/forks/lute"><img src="https://goreportcard.com/badge/github.com/icha-senpai/note/third_party/forks/lute?style=flat-square"></a>
...
<a title="Code Size" target="_blank" href="https://github.com/icha-senpai/note/third_party/forks/lute"><img src="https://img.shields.io/github/languages/code-size/88250/lute.svg?style=flat-square"></a>
<a title="MulanPSL" target="_blank" href="https://github.com/icha-senpai/note/third_party/forks/lute/blob/master/LICENSE"><img src="https://img.shields.io/badge/license-MulanPSL-orange.svg?style=flat-square"></a>
<br>
<a title="GitHub Commits" target="_blank" href="https://github.com/icha-senpai/note/third_party/forks/lute/commits/master"><img src="https://img.shields.io/github/commit-activity/m/88250/lute.svg?style=flat-square"></a>
<a title="Last Commit" target="_blank" href="https://github.com/icha-senpai/note/third_party/forks/lute/commits/master"><img src="https://img.shields.io/github/last-commit/88250/lute.svg?style=flat-square&color=FF9900"></a>
<a title="GitHub Pull Requests" target="_blank" href="https://github.com/icha-senpai/note/third_party/forks/lute/pulls"><img src="https://img.shields.io/github/issues-pr-closed/88250/lute.svg?style=flat-square&color=FF9966"></a>
<a title="Hits" target="_blank" href="https://github.com/88250/hits"><img src="https://hits.b3log.org/88250/lute.svg"></a>
<br><br>
<a title="GitHub Watchers" target="_blank" href="https://github.com/icha-senpai/note/third_party/forks/lute/watchers"><img src="https://img.shields.io/github/watchers/88250/lute.svg?label=Watchers&style=social"></a>  
<a title="GitHub Stars" target="_blank" href="https://github.com/icha-senpai/note/third_party/forks/lute/stargazers"><img src="https://img.shields.io/github/stars/88250/lute.svg?label=Stars&style=social"></a>  
<a title="GitHub Forks" target="_blank" href="https://github.com/icha-senpai/note/third_party/forks/lute/network/members"><img src="https://img.shields.io/github/forks/88250/lute.svg?label=Forks&style=social"></a>  
<a title="Author GitHub Followers" target="_blank" href="https://github.com/88250"><img src="https://img.shields.io/github/followers/88250.svg?label=Followers&style=social"></a>
</p>

<p align="center">
<a href="https://github.com/icha-senpai/note/third_party/forks/lute/blob/master/README.md">中文</a>
</p>

## 💡 Introduction

[Lute](https://github.com/icha-senpai/note/third_party/forks/lute) is a structured Markdown engine that fully implements the latest [GFM](https://github.github.com/gfm/) / [CommonMark](https://commonmark.org) standard, better support for Chinese context.
...
It is recommended to use other libraries (such as [bluemonday](https://github.com/icha-senpai/note/third_party/forks/github/microcosm-cc/bluemonday)) for HTML security filtering, so that it can better adapt to the application scenario.

## 🛠️ Usages

There are three ways to use Lute:

1. Backend: Introduce `github.com/icha-senpai/note/third_party/forks/lute` package in Go language
2. Backend: Start Lute as an HTTP service process for other processes to call, please refer to [here](https://github.com/icha-senpai/note/third_party/forks/lute-http)
...
```shell
go get -u github.com/icha-senpai/note/third_party/forks/lute
```
...
* [Issues](https://github.com/icha-senpai/note/third_party/forks/lute/issues/new/choose)
...
* [goldmark](https://github.com/icha-senpai/note/third_party/forks/github/yuin/goldmark)：A markdown parser written in Go
* [golang-commonmark](https://gitlab.com/golang-commonmark/markdown): A CommonMark-compliant markdown parser and renderer in Go
* [Chroma](https://github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma): A general purpose syntax highlighter in pure Go
...
* [GopherJS](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs): A compiler from Go to JavaScript for running Go code in a browser
