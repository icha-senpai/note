...
type Node struct {
	...
	// 提示块 https://github.com/icha-senpai/note/third_party/forks/lute/issues/203 > [!Type] Title
...
const (
	...
	// 内容块引用（Block Reference） https://github.com/icha-senpai/note/third_party/forks/lute/issues/82
	...
	// ==Mark== 标记语法 https://github.com/icha-senpai/note/third_party/forks/lute/issues/84
	...
	// kramdown 内联属性列表 https://github.com/icha-senpai/note/third_party/forks/lute/issues/89 and https://github.com/icha-senpai/note/third_party/forks/lute/issues/118

	NodeKramdownBlockIAL NodeType = 455 // 块级内联属性列表 {: name="value"}
	NodeKramdownSpanIAL  NodeType = 456 // 行级内联属性列表 *foo*{: name="value"}bar

	// #Tag# 标签语法 https://github.com/icha-senpai/note/third_party/forks/lute/issues/92

	NodeTag            NodeType = 460 // 标签
	NodeTagOpenMarker  NodeType = 461 // 开始标签标记符 #
	NodeTagCloseMarker NodeType = 462 // 结束标签标记符 #

	// 内容块查询嵌入（Block Query Embed）语法 https://github.com/icha-senpai/note/third_party/forks/lute/issues/96
	...
	// 超级块语法 https://github.com/icha-senpai/note/third_party/forks/lute/issues/111
	...
	// 上标下标语法 https://github.com/icha-senpai/note/third_party/forks/lute/issues/113
	...
	// Git 冲突标记 https://github.com/icha-senpai/note/third_party/forks/lute/issues/131
	...
	// 文件注解引用 https://github.com/icha-senpai/note/third_party/forks/lute/issues/155
	...
	// 提示块 https://github.com/icha-senpai/note/third_party/forks/lute/issues/203
