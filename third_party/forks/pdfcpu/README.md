...
[![Test](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/workflows/Test/badge.svg)](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/pdfcpu?status.svg)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/icha-senpai/note/third_party/forks/pdfcpu)](https://goreportcard.com/report/github.com/icha-senpai/note/third_party/forks/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/releases)
...
* [API tests](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/tree/master/pkg/api/test)
* [API samples](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/tree/master/pkg/samples) 
* CLI usage: `$ pdfcpu help cmd`

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/releases).


### Using Go Modules

```
$ git clone https://github.com/icha-senpai/note/third_party/forks/pdfcpu
...
```
$ go install github.com/icha-senpai/note/third_party/forks/pdfcpu/cmd/pdfcpu@latest
```
...
* Please [create](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
* Feature requests - always welcome!
* Bug fixes - always welcome!
* PRs - let's [discuss](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/discussions) first or [create](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/issues/new/choose) an issue.
* pdfcpu is stable but still *Alpha* and occasionally undergoing heavy changes.

### How

* The pdfcpu [discussion board](https://github.com/icha-senpai/note/third_party/forks/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
