...
![Go](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-json/workflows/Go/badge.svg)
[![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/goccy/go-json?status.svg)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-json?tab=doc)
...
If you have the API you need, please submit your issue [here](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-json/issues).

# Features

- Drop-in replacement of `encoding/json`
- Fast ( See [Benchmark section](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-json#benchmarks) )
...
```
go get github.com/icha-senpai/note/third_party/forks/github/goccy/go-json
```

# How to use

Replace import statement from `encoding/json` to `github.com/icha-senpai/note/third_party/forks/github/goccy/go-json`

```
-import "encoding/json"
+import "github.com/icha-senpai/note/third_party/forks/github/goccy/go-json"
```
...
| [json-iterator/go](https://github.com/icha-senpai/note/third_party/forks/github/json-iterator/go) | yes | yes | partial |
| [easyjson](https://github.com/mailru/easyjson) | yes | yes |  no |
| [gojay](https://github.com/francoispqt/gojay) | yes | yes |  no |
| [segmentio/encoding/json](https://github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding/tree/master/json) | yes | yes | partial |
...
- `json-iterator/go` isn't compatible with `encoding/json` in many ways (e.g. https://github.com/icha-senpai/note/third_party/forks/github/json-iterator/go/issues/229 ), but it hasn't been supported for a long time.
...
[go-json-fuzz](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-json-fuzz) is the repository for fuzzing tests.
If you run the test in this repository and find a bug, please commit to corpus to go-json-fuzz and report the issue to [go-json](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-json/issues).
...
The technique for working with `*reflect.rtype` directly from `go-json` is implemented at [rtype.go](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-json/blob/master/internal/runtime/rtype.go)
...
However, this is slow, so it's a good idea to use the `atomic` package for exclusive control as implemented by `segmentio/encoding/json` ( https://github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding/blob/master/json/codec.go#L41-L55 ).
...
If you want to know more, please refer to the implementation [here](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-json/blob/master/internal/runtime/type.go#L36-L100)
