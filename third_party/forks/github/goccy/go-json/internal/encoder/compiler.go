...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/goccy/go-json/internal/errors"
	"github.com/icha-senpai/note/third_party/forks/github/goccy/go-json/internal/runtime"
)
...
func (c *Compiler) listElemCode(typ *runtime.Type) (Code, error) {
	...
	default:
		...
		// See here for related issues: https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-json/issues/370
