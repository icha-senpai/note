...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml)
![Go](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml/workflows/Go/badge.svg)
[![codecov](https://codecov.io/gh/goccy/go-yaml/branch/master/graph/badge.svg)](https://codecov.io/gh/goccy/go-yaml)
[![Go Report Card](https://goreportcard.com/badge/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml)](https://goreportcard.com/report/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml)
...
- Non-intuitive [Marshaler](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/gopkg.in/yaml.v3#Marshaler) / [Unmarshaler](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/gopkg.in/yaml.v3#Unmarshaler)

By the way, libraries such as [ghodss/yaml](https://github.com/icha-senpai/note/third_party/forks/github/ghodss/yaml) and [sigs.k8s.io/yaml](https://github.com/kubernetes-sigs/yaml) also depend on go-yaml/yaml, so if you are using these libraries, the same issues apply: they cannot parse things that go-yaml/yaml cannot parse, and they inherit many of the problems that go-yaml/yaml has.
...
- A better parser than `go-yaml/yaml`. 
  ...
  - Higher coverage in the [YAML Test Suite](https://github.com/yaml/yaml-test-suite?tab=readme-ov-file)
    - YAML Test Suite consists of 402 cases in total, of which `github.com/icha-senpai/note/third_party/forks/external/gopkg.in/yaml.v3` passes `295`. In addition to passing all those test cases, `goccy/go-yaml` successfully passes nearly 60 additional test cases ( 2024/12/15 )
    - The test code is [here](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml/blob/master/yaml_test_suite_test.go#L77)
...
- An API structure that allows the use of not only `Encoder`/`Decoder` but also `Tokenizer` and `Parser` functionalities.
  - [lexer.Tokenize](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml@v1.15.4/lexer#Tokenize)
  - [parser.Parse](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml@v1.15.4/parser#Parse)
...
- Customize the Marshal/Unmarshal behavior for primitive types and third-party library types ([RegisterCustomMarshaler](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml#RegisterCustomMarshaler), [RegisterCustomUnmarshaler](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml#RegisterCustomUnmarshaler))
- Respects `encoding/json` behavior
  ...
  - [json.Marshaler](https://pkg.go.dev/encoding/json#Marshaler) style [marshaler](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml#BytesMarshaler)
  - [json.Unmarshaler](https://pkg.go.dev/encoding/json#Unmarshaler) style [unmarshaler](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml#BytesUnmarshaler)
  - Options for using `MarshalJSON` and `UnmarshalJSON` ([UseJSONMarshaler](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml#UseJSONMarshaler), [UseJSONUnmarshaler](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml#UseJSONUnmarshaler))
- Pretty format for error notifications
- Smart validation processing combined with [go-playground/validator](https://github.com/go-playground/validator)
  - [example test code is here](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml/blob/45889c98b0a0967240eb595a1bd6896e2f575106/testdata/validate_test.go#L12)
...
- https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml/wiki/Users

The source data is [here](https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml/network/dependents). 
...
```sh
go get github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml
```
...
For custom marshal/unmarshaling, implement either `Bytes` or `Interface` variant of marshaler/unmarshaler. The difference is that while `BytesMarshaler`/`BytesUnmarshaler` behaves like [`encoding/json`](https://pkg.go.dev/encoding/json) and `InterfaceMarshaler`/`InterfaceUnmarshaler` behaves like [`github.com/icha-senpai/note/third_party/forks/external/gopkg.in/yaml.v2`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/gopkg.in/yaml.v2).
...
import (
  ...
  "github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml"
)
...
```sh
git clone https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml.git
