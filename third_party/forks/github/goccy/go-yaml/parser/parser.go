...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml/lexer"
...
func newParser(tokens token.Tokens, mode Mode, opts []Option) (*parser, error) {
	...
	if mode&ParseComments != 0 {
		...
		for _, tk := range tokens {
			...
			// https://github.com/icha-senpai/note/third_party/forks/github/goccy/go-yaml/issues/254
