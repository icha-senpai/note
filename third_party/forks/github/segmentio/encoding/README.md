# encoding ![build status](https://github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding/actions/workflows/test.yml/badge.svg) [![Go Report Card](https://goreportcard.com/badge/github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding)](https://goreportcard.com/report/github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding) [![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding?status.svg)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding)
...
## encoding/json [![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding/json?status.svg)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding/json)
...
```go
import (
    "github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding/json"
)
```
...
**Comparing to github.com/icha-senpai/note/third_party/forks/github/json-iterator/go (`v1.1.10`)**
```
name                           old time/op    new time/op    delta
...
## encoding/iso8601 [![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding/iso8601?status.svg)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/segmentio/encoding/iso8601)
