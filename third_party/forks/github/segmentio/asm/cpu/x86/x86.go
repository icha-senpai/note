...
import (
	"github.com/icha-senpai/note/third_party/forks/github/segmentio/asm/cpu/cpuid"
	. "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/cpu"
)
...
func ABI() CPU {
	cpu := CPU(0)
	cpu.set(SSE, true) // TODO: github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/cpu assumes all CPUs have SEE?
	cpu.set(SSE2, X86.HasSSE2)
	cpu.set(SSE3, X86.HasSSE3)
	cpu.set(SSE41, X86.HasSSE41)
	cpu.set(SSE42, X86.HasSSE42)
	cpu.set(SSE4A, false) // TODO: add upstream support in github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/cpu?
	...
	cpu.set(AVX512VP2INTERSECT, false) // TODO: add upstream support in github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/cpu?
	cpu.set(AVX512VPOPCNTDQ, X86.HasAVX512VPOPCNTDQ)
	cpu.set(CMOV, true) // TODO: github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/cpu assumes all CPUs have CMOV?
	return cpu
}
