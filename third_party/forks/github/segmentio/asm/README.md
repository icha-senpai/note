# asm ![build status](https://github.com/icha-senpai/note/third_party/forks/github/segmentio/asm/actions/workflows/go.yml/badge.svg) [![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/segmentio/asm?status.svg)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/segmentio/asm)
...
```
pkg: github.com/icha-senpai/note/third_party/forks/github/segmentio/asm/ascii
...
```
pkg: github.com/icha-senpai/note/third_party/forks/github/segmentio/asm/bswap
name    old time/op    new time/op     delta
...
```
pkg: github.com/icha-senpai/note/third_party/forks/github/segmentio/asm/qsort
name            old time/op    new time/op     delta
...
`github.com/icha-senpai/note/third_party/forks/github/segmentio/asm` at the root of the repository, and the second
...
dependency of programs using `github.com/icha-senpai/note/third_party/forks/github/segmentio/asm`, keeping the
