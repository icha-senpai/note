# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai.svg)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai)](https://goreportcard.com/report/github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai)
...
```
go get github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai
```
...
See also: https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai#ClientConfig
</details>
...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai"
	"github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai/jsonschema"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai/issues/9)
...
- [Counting Tokens For Chat API Calls](https://github.com/icha-senpai/note/third_party/forks/github/pkoukk/tiktoken-go#counting-tokens-for-chat-api-calls)
- [How to count tokens with tiktoken](https://github.com/openai/openai-cookbook/blob/main/examples/How_to_count_tokens_with_tiktoken.ipynb)

**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/icha-senpai/note/third_party/forks/github/sashabaranov/go-openai/graphs/contributors) and sponsors of this project:
