...
[![Build Status](https://travis-ci.org/ConradIrwin/font.svg?branch=master)](https://travis-ci.org/ConradIrwin/font) [![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/ConradIrwin/font?status.svg)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/ConradIrwin/font)

A collection of Go packages for parsing and encoding OpenType fonts.

The main contribution of this repository is the [SFNT](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/ConradIrwin/font/sfnt) library which provides support for parsing OpenType, TrueType, TrueType Collection, WOFF, and WOFF2 fonts.

To use this library in your project:

```
go get github.com/icha-senpai/note/third_party/forks/github/ConradIrwin/font/sfnt
```

Also included is a utility called `font` that can do various useful things with fonts:

```
go install github.com/icha-senpai/note/third_party/forks/github/ConradIrwin/font/cmd/font@latest
```
