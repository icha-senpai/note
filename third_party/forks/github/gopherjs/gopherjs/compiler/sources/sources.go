...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/neelance/astrewrite"
	...
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/compiler/internal/analysis"
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/compiler/internal/typeparams"
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/compiler/linkname"
)
...
func (s *Sources) TypeCheck(importer Importer, sizes types.Sizes, tContext *types.Context) error {
	...
	// separately, if any. https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/issues/119.
