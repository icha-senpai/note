...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/compiler/typesutil"
)
...
func (fc *funcContext) translateConversion(expr ast.Expr, desiredType types.Type) *expression {
	...
	case *types.Pointer:
		...
		if types.Identical(exprType, types.Typ[types.UnsafePointer]) {
			...
			// Possibly related to https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/issues/1001.
