...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/compiler/filter"
...
func (fc *funcContext) translateStmt(stmt ast.Stmt, label *types.Label) {
	...
	case *ast.ReturnStmt:
		...
		// See: https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/issues/603.
