...
// because they're needed for internalization/externalization of time.Time/Date. See issue https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/issues/279.
func init() {
