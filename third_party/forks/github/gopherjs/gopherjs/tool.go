...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/spf13/pflag"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sync/errgroup"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/term"
	...
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/internal/sysutil"
)
...
func runNode(script string, args []string, dir string, quiet bool, out io.Writer) error {
	...
	if runtime.GOOS != "windows" {
		...
		// https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/pull/669#issuecomment-319319483).
		//
