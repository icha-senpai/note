...
import (
	...
	_ "github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/build/versionhack" // go/build release tags hack.
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/compiler"
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/compiler/gopherjspkg"
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/compiler/incjs"
	"github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/compiler/natives"
)
...
func (sc simpleCtx) Match(patterns []string) ([]string, error) {
	if sc.isVirtual {
		...
		// https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/issues/1021 is implemented.
		args := []string{}
...
func isGopherJSImportPath(importPath string) bool {
	switch importPath {
	case "github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/js", "github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/nosync":
		return true
	default:
		return false
	}
