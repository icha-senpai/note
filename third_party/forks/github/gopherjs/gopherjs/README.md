...
[![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/js?status.svg)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/js)
[![Sourcegraph](https://sourcegraph.com/github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/-/badge.svg)](https://sourcegraph.com/github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs?badge)
[![Github Actions CI](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/actions/workflows/ci.yaml/badge.svg)](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/actions/workflows/ci.yaml)
...
- 📢 Report and discuss [issues](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/issues).
- 🎓 Share your knowledge and experience through [articles](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/wiki/Community-Tutorials-and-Blogs) and [documentation](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/tree/master/doc).
- 🛠️ Write GopherJS [bindings](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/wiki/Bindings) for other libraries or [contribute](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/wiki/Developer-Guidelines) to GopherJS itself.

### What's new?

- 2025-08-19: Go 1.19 beta2 is [released](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/releases/tag/v1.19.0-beta2), with full generics support!
- 2024-02-24: Go 1.19 support is [available](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/releases/tag/v1.19.0-beta1)!
- 2022-08-18: Go 1.18 support is [available](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/releases/tag/v1.18.0-beta2%2Bgo1.18.5)!
...
Nearly everything, including Goroutines ([compatibility documentation](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/blob/master/doc/compatibility.md)). Performance is quite good in most cases, see [HTML5 game engine benchmark](https://ajhager.github.io/engi/demos/botmark.html). Cgo is not supported.

### Installation and Usage

GopherJS [requires Go 1.21 or newer](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/blob/master/doc/compatibility.md#go-version-compatibility). If you need an older Go
version, you can use an [older GopherJS release](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/releases).

Install GopherJS with `go install`:

```
go install github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs@v1.21.0  # Or replace 'v1.21.0' with another version.
```
...
On supported `GOOS` platforms, it's possible to make system calls (file system access, etc.) available. See [doc/syscalls.md](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/blob/master/doc/syscalls.md) for instructions on how to do so.
...
- [Bindings to JavaScript APIs and libraries](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/wiki/bindings)
- [GopherJS Blog](https://medium.com/gopherjs)
- [GopherJS on Twitter](https://twitter.com/GopherJS)
- [Examples, tutorials and blogs](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/wiki/Community-Tutorials-and-Blogs)

### Getting started

#### Interacting with the DOM

The package `github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/js` (see [documentation](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/js)) provides functions for interacting with native JavaScript APIs. For example the line
...
If you're looking to make changes to the GopherJS compiler, see [Developer Guidelines](https://github.com/icha-senpai/note/third_party/forks/github/gopherjs/gopherjs/wiki/Developer-Guidelines) for additional developer information.
