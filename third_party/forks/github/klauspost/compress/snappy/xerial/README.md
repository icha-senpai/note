...
* Uses [S2](https://github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/tree/master/s2#snappy-compatibility) for better/faster compression and decompression.
