...
Installation: `go get -u github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2`

Full package documentation:
 
[![godoc][1]][2]

[1]: https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress?status.svg
[2]: https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2
...
Binaries can be downloaded on the [Releases Page](https://github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/releases).

Installing then requires Go to be installed. To install them, use:

`go install github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2/cmd/s2c@latest && go install github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2/cmd/s2d@latest`

To build binaries to the current folder use:

`go build github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2/cmd/s2c && go build github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2/cmd/s2d`
...
If you are mainly looking for better compression [zstandard](https://github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/tree/master/zstd#zstd)
...
For full stream decompression S2 offers a [DecodeConcurrent](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2#Reader.DecodeConcurrent) 
...
There is a [snappy](https://github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/tree/master/snappy) package that can be used by
simply changing imports from `github.com/icha-senpai/note/third_party/forks/github/golang/snappy` to `github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/snappy`.
...
Features like [quick forward skipping without decompression](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2#Reader.Skip)
are also available for Snappy streams.

If you know you are only decompressing snappy streams, setting [`ReaderMaxBlockSize(64<<10)`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2#ReaderMaxBlockSize)
...
The returned [ReadSeeker](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2#ReadSeeker) contains a shallow reference to the existing Reader,
...
Indexes can also be read outside the decoder using the [Index](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2#Index) type.
...
For compact storage [RemoveIndexHeaders](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2#RemoveIndexHeaders) can be used to remove any redundant info from 
a serialized index. If you remove the header it must be restored before [Loading](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2#Index.Load).

This is expected to save 20 bytes. These can be restored using [RestoreIndexHeaders](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/s2#RestoreIndexHeaders). This removes a layer of security, but is the most compact representation. Returns nil if headers contains errors.
...
See [using indexes](https://github.com/icha-senpai/note/third_party/forks/github/klauspost/compress/tree/master/s2#using-indexes) for functions that perform the operations with a simpler interface.
...
This code is based on the [Snappy-Go](https://github.com/icha-senpai/note/third_party/forks/github/golang/snappy) implementation.
