...
<p align="center">
    ...
    <a href="https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/xuri/excelize/v2"><img src="https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white" alt="go.dev"></a>
...
```bash
go get github.com/icha-senpai/note/third_party/forks/github/xuri/excelize/v2
```
