...
I'm using [Github](https://github.com/icha-senpai/note/third_party/forks/github/mssola/useragent) in order to host the
code. Thus, in order to report issues you can do it on its [issue
tracker](https://github.com/icha-senpai/note/third_party/forks/github/mssola/useragent/issues). A couple of notes on
reports:
