...
bench() {
    ...
    if [ "${replace}" != "" ]; then
        find ./benchmark/ -iname '*.go' -exec sed -i -E "s|github.com/icha-senpai/note/third_party/forks/github/pelletier/go-toml/v2|${replace}|g" {} \;
        go get "${replace}"
    fi
...
benchmark() {
    ...
    -a)
        ...
        bench HEAD "${v2stats}" "github.com/icha-senpai/note/third_party/forks/github/pelletier/go-toml/v2"
        v1stats=`fmktemp go-toml-v1`
        bench HEAD "${v1stats}" "github.com/pelletier/go-toml"
        bsstats=`fmktemp bs-toml`
        bench HEAD "${bsstats}" "github.com/icha-senpai/note/third_party/forks/github/BurntSushi/toml"
