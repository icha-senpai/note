...
To report a potential security vulnerability, please create a [security advisory](https://github.com/icha-senpai/note/third_party/forks/github/gofrs/flock/security/advisories/new).
...
This project submits security [results](https://scorecard.dev/viewer/?uri=github.com/icha-senpai/note/third_party/forks/github/gofrs/flock) to the [OpenSSF Scorecard](https://securityscorecards.dev/).
