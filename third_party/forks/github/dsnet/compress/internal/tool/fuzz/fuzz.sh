...
if [ ! -d ".work" ]; then
	...
	git clone https://github.com/icha-senpai/note/third_party/forks/github/dsnet/compress-fuzz.git .work
fi

PKG=$(echo $1 | sed 's/\/*$//g')
PKG_PATH="github.com/icha-senpai/note/third_party/forks/github/dsnet/compress/internal/tool/fuzz"
shift
