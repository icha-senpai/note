...
[![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/dsnet/compress/cmp?status.svg)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/dsnet/compress)
[![Build Status](https://travis-ci.org/dsnet/compress.svg?branch=master)](https://travis-ci.org/dsnet/compress)
[![Report Card](https://goreportcard.com/badge/github.com/icha-senpai/note/third_party/forks/github/dsnet/compress)](https://goreportcard.com/report/github.com/icha-senpai/note/third_party/forks/github/dsnet/compress)
...
To see what work still remains, see the [Task List](https://github.com/icha-senpai/note/third_party/forks/github/dsnet/compress/wiki/Task-List).

## Performance  ##

See [Performance Metrics](https://github.com/icha-senpai/note/third_party/forks/github/dsnet/compress/wiki/Performance-Metrics).


## Frequently Asked Questions ##

See [Frequently Asked Questions](https://github.com/icha-senpai/note/third_party/forks/github/dsnet/compress/wiki/Frequently-Asked-Questions).
...
```go get -u github.com/icha-senpai/note/third_party/forks/github/dsnet/compress```
...
| Package | Description |
| :------ | :---------- |
| [brotli](http://godoc.org/github.com/icha-senpai/note/third_party/forks/github/dsnet/compress/brotli) | Package brotli implements the Brotli format, described in RFC 7932. |
| [bzip2](http://godoc.org/github.com/icha-senpai/note/third_party/forks/github/dsnet/compress/bzip2) | Package bzip2 implements the BZip2 compressed data format. |
| [flate](http://godoc.org/github.com/icha-senpai/note/third_party/forks/github/dsnet/compress/flate) | Package flate implements the DEFLATE format, described in RFC 1951. |
| [xflate](http://godoc.org/github.com/icha-senpai/note/third_party/forks/github/dsnet/compress/xflate) | Package xflate implements the XFLATE format, an random-access extension to DEFLATE. |
