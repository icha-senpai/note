...
var (
	...
	ErrExperimentalUnsupported  = errors.New("this functionality is only supported when using the pdfium_experimental build flag, see https://github.com/icha-senpai/note/third_party/forks/github/klippa-app/go-pdfium#experimental for more information")
