...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/klippa-app/go-pdfium/errors"
	...
	"github.com/icha-senpai/note/third_party/forks/github/onsi/gomega/types"
)
		...
		When("is opened", func() {
			Context("when the page text is requested", func() {
				It("returns the correct text", func() {
					...
					Expect(err).To(BeNil())
					ioutil.WriteFile("/home/jeroen/henkus.txt", []byte(pageText.Text), 0644)
					Expect(pageText).To(Equal(&responses.GetPageText{
						Page: 1,
