...
```bash
go get github.com/icha-senpai/note/third_party/forks/github/pkoukk/tiktoken-go
```
...
Include if you require this loader: [tiktoken_loader](https://github.com/icha-senpai/note/third_party/forks/github/pkoukk/tiktoken-go-loader)
