...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/gin-gonic/gin/internal/bytesconv"
	filesystem "github.com/icha-senpai/note/third_party/forks/github/gin-gonic/gin/internal/fs"
	"github.com/icha-senpai/note/third_party/forks/github/gin-gonic/gin/render"
	"github.com/icha-senpai/note/third_party/forks/github/quic-go/quic-go/http3"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/http2"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/http2/h2c"
)
...
func (engine *Engine) Run(addr ...string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://github.com/icha-senpai/note/third_party/forks/github/gin-gonic/gin/blob/master/docs/doc.md#dont-trust-all-proxies for details.")
	}
