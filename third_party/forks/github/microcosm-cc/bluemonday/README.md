# bluemonday [![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/microcosm-cc/bluemonday?status.png)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/microcosm-cc/bluemonday) [![Sourcegraph](https://sourcegraph.com/github.com/icha-senpai/note/third_party/forks/github/microcosm-cc/bluemonday/-/badge.svg)](https://sourcegraph.com/github.com/icha-senpai/note/third_party/forks/github/microcosm-cc/bluemonday?badge)
...
The policy containing the allowlist is applied using a fast non-validating, forward only, token-based parser implemented in the [Go net/html library](https://godoc.org/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/html) by the core Go team.
...
We are passing our extensive test suite (including AntiSamy tests as well as tests for any issues raised). Check for any [unresolved issues](https://github.com/icha-senpai/note/third_party/forks/github/microcosm-cc/bluemonday/issues?page=1&state=open) to see whether anything may be a blocker for you.
...
Install using `go get github.com/icha-senpai/note/third_party/forks/github/microcosm-cc/bluemonday`
