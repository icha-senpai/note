...
- #354: Updated github.com/icha-senpai/note/third_party/forks/external/golang.org/x/crypto which included bug fixes
...
- Upgraded `Masterminds/goutils` to `v1.1.1`. see the [Security Advisory](https://github.com/icha-senpai/note/third_party/forks/github/Masterminds/goutils/security/advisories/GHSA-xg2h-wx96-xgxr)
