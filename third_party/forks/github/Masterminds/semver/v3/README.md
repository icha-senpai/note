...
[![GoDoc](https://img.shields.io/static/v1?label=godoc&message=reference&color=blue)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/Masterminds/semver/v3)
...
Note, import `github.com/icha-senpai/note/third_party/forks/github/Masterminds/semver/v3` to use the latest version.
