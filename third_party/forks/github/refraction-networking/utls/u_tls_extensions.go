...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/refraction-networking/utls/dicttls"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/crypto/cryptobyte"
)
...
func (e *PSKKeyExchangeModesExtension) Write(b []byte) (int, error) {
	...
	// https://github.com/icha-senpai/note/third_party/forks/github/refraction-networking/utls/pull/58#discussion_r522354105
