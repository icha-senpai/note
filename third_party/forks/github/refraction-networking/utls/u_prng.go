 ...
 * https://github.com/icha-senpai/note/third_party/forks/github/refraction-networking/utls/blob/master/LICENSE
 */
...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/crypto/sha3"
)
...
func (p *prng) Read(b []byte) (int, error) {
	...
	// https://godoc.org/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/crypto/sha3#ShakeHash
