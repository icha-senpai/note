...
[![Go
Reference](https://pkg.go.dev/badge/github.com/icha-senpai/note/third_party/forks/github/golang-jwt/jwt/v5.svg)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/golang-jwt/jwt/v5)
...
```sh
go get -u github.com/icha-senpai/note/third_party/forks/github/golang-jwt/jwt/v5
```

2. Import it in your code:

```go
import "github.com/icha-senpai/note/third_party/forks/github/golang-jwt/jwt/v5"
```
...
See [the project documentation](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/golang-jwt/jwt/v5)
for examples of usage:

* [Simple example of parsing and validating a
  token](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/golang-jwt/jwt/v5#example-Parse-Hmac)
* [Simple example of building and signing a
  token](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/golang-jwt/jwt/v5#example-New-Hmac)
* [Directory of
  Examples](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/golang-jwt/jwt/v5#pkg-examples)
...
pkg.go.dev](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/golang-jwt/jwt/v5). Additional
