...
Parse many date strings without knowing format in advance.  Uses a scanner to read bytes and use a state machine to find format.  Much faster than shotgun based parse methods.  See [bench_test.go](https://github.com/icha-senpai/note/third_party/forks/github/araddon/dateparse/blob/master/bench_test.go) for performance comparison.


[![Code Coverage](https://codecov.io/gh/araddon/dateparse/branch/master/graph/badge.svg)](https://codecov.io/gh/araddon/dateparse)
[![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/araddon/dateparse?status.svg)](http://godoc.org/github.com/icha-senpai/note/third_party/forks/github/araddon/dateparse)
...
[Date Parse CLI](https://github.com/icha-senpai/note/third_party/forks/github/araddon/dateparse/blob/master/dateparse)


Extended example
-------------------

https://github.com/icha-senpai/note/third_party/forks/github/araddon/dateparse/blob/master/example/main.go
