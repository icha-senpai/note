...
```
go get github.com/icha-senpai/note/third_party/forks/github/ClarkThan/ahocorasick
```

## API Description
https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/ClarkThan/ahocorasick
...
import (
    ...
    "github.com/icha-senpai/note/third_party/forks/github/ClarkThan/ahocorasick"
)
