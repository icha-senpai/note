...
[API documentation](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/leodido/go-urn).
...
```
go get github.com/icha-senpai/note/third_party/forks/github/leodido/go-urn
```
...
import (
	"fmt"
	"github.com/icha-senpai/note/third_party/forks/github/leodido/go-urn"
)
