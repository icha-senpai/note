...
[![Golang Documentation](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma?status.svg)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma) [![CI](https://github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma/actions/workflows/ci.yml/badge.svg)](https://github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma/actions/workflows/ci.yml) [![Slack chat](https://img.shields.io/static/v1?logo=slack&style=flat&label=slack&color=green&message=gophers)](https://invite.slack.golangbridge.org/)
...
[lexers](https://github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma/tree/master/lexers),
[formatters](https://github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma/tree/master/formatters) and
[styles](https://github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma/tree/master/styles).
...
See notes in [pygments-lexers.txt](https://github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma/blob/master/pygments-lexers.txt)
...
When you work with one of [Chroma's styles](https://github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma/tree/master/styles), know that the `chroma.Background` token type provides the default style for tokens. It does so by defining a foreground color and background color.
...
Binaries are available to install from [the releases page](https://github.com/icha-senpai/note/third_party/forks/github/alecthomas/chroma/releases).
