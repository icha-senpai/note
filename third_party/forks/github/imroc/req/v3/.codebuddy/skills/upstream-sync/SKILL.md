...
req modifies Go stdlib net/http, github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/http2, and quic-go source code internally. This skill tracks upstream changes and generates reports for manual sync.
...
| `github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/http2` | `internal/http2/` | `merge upstream http2: <date>(<hash>)` |
| `github.com/icha-senpai/note/third_party/forks/github/quic-go/quic-go` | `internal/http3/` | `port quic-go <version>` |
...
3. **Check quic-go upstream**
   - Fetch latest quic-go releases: `https://github.com/icha-senpai/note/third_party/forks/github/quic-go/quic-go/releases`
   - Compare with current version in go.mod
   - Identify breaking changes (removed APIs, renamed types)

4. **Check github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/http2 upstream**
