...
- Prompt: "Use the upstream-tracker agent to check upstream changes. Check Go stdlib net/http, github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/http2, and quic-go for new releases/commits since last sync. Generate a sync report. If breaking changes found, open an issue with gh issue create. Update STATE.md upstream sync baselines."
