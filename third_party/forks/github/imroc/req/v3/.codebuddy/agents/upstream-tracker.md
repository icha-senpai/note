...
description: Upstream sync tracking agent. Monitors Go stdlib net/http, github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/http2, and quic-go for changes that need manual sync into req's modified code. Generates reports. Used proactively for upstream tracking.
