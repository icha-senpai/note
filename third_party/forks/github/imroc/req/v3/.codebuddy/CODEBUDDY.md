...
- **模块路径**: `github.com/icha-senpai/note/third_party/forks/github/imroc/req/v3`
...
2. **Go 标准库 HTTP/2**（github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/http2）— 魔改后放在 `internal/http2/`。
...
- `github.com/icha-senpai/note/third_party/forks/github/refraction-networking/utls` — TLS 指纹模拟
- `github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net`、`github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text`、`github.com/icha-senpai/note/third_party/forks/external/golang.org/x/crypto` — Go 官方扩展库
- `github.com/icha-senpai/note/third_party/forks/github/andybalholm/brotli`、`github.com/icha-senpai/note/third_party/forks/github/klauspost/compress` — 压缩

## 架构要点

- 根目录核心文件：`client.go`、`request.go`、`response.go`、`transport.go`（魔改自标准库）、`middleware.go`
- `internal/http2/` — 魔改自 github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/http2
