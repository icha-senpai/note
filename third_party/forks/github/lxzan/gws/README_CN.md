...
[![Go Test](https://github.com/icha-senpai/note/third_party/forks/github/lxzan/gws/actions/workflows/go.yml/badge.svg?branch=main)](https://github.com/icha-senpai/note/third_party/forks/github/lxzan/gws/actions/workflows/go.yml)
[![go-reportcard](https://goreportcard.com/badge/github.com/icha-senpai/note/third_party/forks/github/lxzan/gws)](https://goreportcard.com/report/github.com/icha-senpai/note/third_party/forks/github/lxzan/gws)
...
[![go-version](https://img.shields.io/badge/go-%3E%3D1.18-30dff3?style=flat-square&logo=go)](https://github.com/icha-senpai/note/third_party/forks/github/lxzan/gws)
...
```go
go test -benchmem -run=^$ -bench . github.com/icha-senpai/note/third_party/forks/github/lxzan/gws
goos: linux
goarch: amd64
pkg: github.com/icha-senpai/note/third_party/forks/github/lxzan/gws
...
PASS
ok      github.com/icha-senpai/note/third_party/forks/github/lxzan/gws    17.231s
```
...
```bash
go get -v github.com/icha-senpai/note/third_party/forks/github/lxzan/gws@latest
```
...
import "github.com/icha-senpai/note/third_party/forks/github/lxzan/gws"
...
import (
	"crypto/tls"
	"github.com/icha-senpai/note/third_party/forks/github/lxzan/gws"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/proxy"
	"log"
)
...
- [klauspost/compress](https://github.com/icha-senpai/note/third_party/forks/github/klauspost/compress)
