...
This is done using os.Stat and github.com/icha-senpai/note/third_party/forks/github/gabriel-vasile/mimetype
...
More information on https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/language
