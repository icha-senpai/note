...
<a title="Doc for ants" target="_blank" href="https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/panjf2000/ants/v2?tab=doc"><img src="https://img.shields.io/badge/go.dev-doc-007d9c?style=flat-square&logo=read-the-docs" /></a>
...
```powershell
go get -u github.com/icha-senpai/note/third_party/forks/github/panjf2000/ants/v2
```

## 🛠 How to use
Check out [the examples](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/panjf2000/ants/v2#pkg-examples) for basic usage.
...
Check out [ants.Options](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/panjf2000/ants/v2#Options) and [ants.Option](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/panjf2000/ants/v2#Option) for more details.
