...
func RandomString(size int, charset []rune) string {
	...
	if len(charset) == 1 {
		...
		// -> https://github.com/icha-senpai/note/third_party/forks/github/samber/lo/issues/679
		for i := 0; i < size; i++ {
...
// See https://github.com/icha-senpai/note/third_party/forks/github/samber/lo/issues/788
