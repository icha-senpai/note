# Description
Command line tool for [gowebdav](https://github.com/icha-senpai/note/third_party/forks/github/studio-b12/gowebdav) library.
...
# Install
```sh
go get -u github.com/icha-senpai/note/third_party/forks/github/studio-b12/gowebdav/cmd/gowebdav
```
