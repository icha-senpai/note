...
If you believe the contents of any of these files need to be changed, please [open an issue](https://github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/issues/new/choose).
