...
* **Feature**: Adds support for `SourceIdentity` to `stscreds.AssumeRoleProvider` [#1588](https://github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/pull/1588). Fixes [#1575](https://github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/issues/1575)
* **Feature**: Updated `github.com/icha-senpai/note/third_party/forks/github/aws/smithy-go` to latest version
* **Dependency Update**: Updated to the latest SDK module versions
...
* **Feature**: Adds support for Tags and TransitiveTagKeys to stscreds.AssumeRoleProvider. Closes https://github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/issues/723
* **Feature**: Updated `github.com/icha-senpai/note/third_party/forks/github/aws/smithy-go` to latest version
* **Dependency Update**: Updated to the latest SDK module versions
...
* **Feature**: Updated `github.com/icha-senpai/note/third_party/forks/github/aws/smithy-go` to latest version
* **Bug Fix**: Fixed example usages of aws.CredentialsCache ([#1275](https://github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/pull/1275))
* **Dependency Update**: Updated to the latest SDK module versions
