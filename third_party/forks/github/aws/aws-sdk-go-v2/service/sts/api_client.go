...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/aws/protocol/query"
...
func withOperationMetrics(parent context.Context, mp metrics.MeterProvider) (context.Context, error) {
	...
	meter := mp.Meter("github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/sts")
	om := &operationMetrics{}
...
func operationTracer(p tracing.TracerProvider) tracing.Tracer {
	return p.Tracer("github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/sts")
}
...
func (c *Client) invokeOperation(
	...
	handler := smithyhttp.NewClientHandlerWithOptions(options.HTTPClient, func(o *smithyhttp.ClientHandler) {
		o.Meter = options.MeterProvider.Meter("github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/sts")
	})
...
func addRetry(stack *middleware.Stack, o Options, c *Client) error {
	attempt := retry.NewAttemptMiddleware(o.Retryer, smithyhttp.RequestCloner, func(m *retry.Attempt) {
		...
		m.OperationMeter = o.MeterProvider.Meter("github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/sts")
