...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/aws/defaults"
	...
	"github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/aws/signer/v4"
	...
	internalConfig "github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/internal/configsources"
	...
	internalChecksum "github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/internal/checksum"
	...
	s3sharedconfig "github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/internal/s3shared/config"
	s3cust "github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/s3/internal/customizations"
	smithy "github.com/icha-senpai/note/third_party/forks/github/aws/smithy-go"
	smithydocument "github.com/icha-senpai/note/third_party/forks/github/aws/smithy-go/document"
...
func withOperationMetrics(parent context.Context, mp metrics.MeterProvider) (context.Context, error) {
	...
	meter := mp.Meter("github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/s3")
	om := &operationMetrics{}
...
func operationTracer(p tracing.TracerProvider) tracing.Tracer {
	return p.Tracer("github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/s3")
}
...
func (c *Client) invokeOperation(
	...
	handler := smithyhttp.NewClientHandlerWithOptions(options.HTTPClient, func(o *smithyhttp.ClientHandler) {
		o.Meter = options.MeterProvider.Meter("github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/s3")
	})
...
func addRetry(stack *middleware.Stack, o Options, c *Client) error {
	attempt := retry.NewAttemptMiddleware(o.Retryer, smithyhttp.RequestCloner, func(m *retry.Attempt) {
		...
		m.OperationMeter = o.MeterProvider.Meter("github.com/icha-senpai/note/third_party/forks/github/aws/aws-sdk-go-v2/service/s3")
