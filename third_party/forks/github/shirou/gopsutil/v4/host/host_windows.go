...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/shirou/gopsutil/v4/process"
)
...
func HostIDWithContext(_ context.Context) (string, error) {
	// there has been reports of issues on 32bit using github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/windows/registry, see https://github.com/shirou/gopsutil/pull/312#issuecomment-277422612
