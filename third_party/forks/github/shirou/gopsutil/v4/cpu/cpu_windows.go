...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/windows/registry"
...
func TimesWithContext(_ context.Context, percpu bool) ([]TimesStat, error) {
	...
	// see https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/windows#LazyProc.Call
...
func perfInfoSingleGroup() ([]win32_SystemProcessorPerformanceInformation, error) {
	...
	// See https://godoc.org/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/windows#LazyProc.Call for more information
