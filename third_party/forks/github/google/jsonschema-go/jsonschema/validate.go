...
func (st *state) validate(instance reflect.Value, schema *Schema, callerAnns *annotations) (err error) {
	...
	// Validating structs is problematic. See https://github.com/icha-senpai/note/third_party/forks/github/google/jsonschema-go/issues/23.
	if instance.Kind() == reflect.Struct {
		return errors.New("cannot validate against a struct; see https://github.com/icha-senpai/note/third_party/forks/github/google/jsonschema-go/issues/23 for details")
	}
