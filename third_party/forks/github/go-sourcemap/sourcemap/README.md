...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/icha-senpai/note/third_party/forks/github/go-sourcemap/sourcemap)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/go-sourcemap/sourcemap)
...
```shell
go get -u github.com/icha-senpai/note/third_party/forks/github/go-sourcemap/sourcemap
```
