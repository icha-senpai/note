...
## New Code Generation
For extra performance use `regexp2` with [`regexp2cg`](https://github.com/icha-senpai/note/third_party/forks/github/dlclark/regexp2cg). It is a code generation utility for `regexp2` and you can likely improve your regexp runtime performance by 3-10x in hot code paths. As always you should benchmark your specifics to confirm the results. Give it a try!

## Installing
This is a go-gettable library, so install is easy:

    go get github.com/icha-senpai/note/third_party/forks/github/dlclark/regexp2

To use the new Code Generation (while it's in beta) you'll need to use the `code_gen` branch:

    go get github.com/icha-senpai/note/third_party/forks/github/dlclark/regexp2@code_gen
...
* change singleline behavior for `$` to only match end of string (like RE2) (see [#24](https://github.com/icha-senpai/note/third_party/forks/github/dlclark/regexp2/issues/24))
...
See [PR #58](https://github.com/icha-senpai/note/third_party/forks/github/dlclark/regexp2/pull/58) for more details and 
