...
type MemoryInstance struct {
	...
	// waiters implements atomic wait and notify. It is implemented similarly to github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sync/semaphore,
