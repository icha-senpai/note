...
Going beyond Go's SDK limitations can be accomplished with their [x/sys library](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sys/unix).
...
even use of x/sys can require platform-specifics. For example, [mmap-go](https://github.com/icha-senpai/note/third_party/forks/github/edsrzf/mmap-go)
...
Since [wazero v1.0.0-pre.9](https://github.com/icha-senpai/note/third_party/forks/github/tetratelabs/wazero/releases/tag/v1.0.0-pre.9), the runtime
...
[native_check]: https://github.com/icha-senpai/note/third_party/forks/github/tetratelabs/wazero/issues/1409
