...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/icholy/digest/internal/param"
)
...
func (c *Credentials) String() string {
	...
	// See: https://github.com/icha-senpai/note/third_party/forks/github/icholy/digest/issues/8
	pp = append(pp, param.Param{
		Key:   "response",
		Value: c.Response,
		Quote: true,
