...
[![GoDoc](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/denisbrodbeck/machineid?status.svg)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/denisbrodbeck/machineid) [![Go Report Card](https://goreportcard.com/badge/github.com/icha-senpai/note/third_party/forks/github/denisbrodbeck/machineid)](https://goreportcard.com/report/github.com/icha-senpai/note/third_party/forks/github/denisbrodbeck/machineid)
...
```bash
go get github.com/icha-senpai/note/third_party/forks/github/denisbrodbeck/machineid
```

You can also add the cli app directly to your `$GOPATH/bin` with

```bash
go get github.com/icha-senpai/note/third_party/forks/github/denisbrodbeck/machineid/cmd/machineid
```
