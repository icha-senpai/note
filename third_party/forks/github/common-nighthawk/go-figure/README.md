...
## Installation
`go get github.com/icha-senpai/note/third_party/forks/github/common-nighthawk/go-figure`

## Basic Example
```go
package main

import("github.com/icha-senpai/note/third_party/forks/github/common-nighthawk/go-figure")
...
The font files are available in the [fonts folder](https://github.com/icha-senpai/note/third_party/forks/github/common-nighthawk/go-figure/tree/master/fonts)
and on [figlet.org](http://www.figlet.org/fontdb.cgi).

Here are two examples--

`myFigure := figure.NewFigureWithFont("Foo Bar", "/home/ubuntu/go/src/github.com/icha-senpai/note/third_party/forks/github/common-nighthawk/go-figure/fonts/alphabet.flf", true)`
