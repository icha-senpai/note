...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/fsnotify/fsnotify/internal"
			...
			if event.Has(Remove) {
				...
				if path.isDir {
					...
					if found {
						...
						// isDir check added in 8611c35 (2016): https://github.com/icha-senpai/note/third_party/forks/github/fsnotify/fsnotify/pull/111
						//
