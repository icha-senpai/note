...
# Set [![GoDoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/fatih/set) [![Build Status](http://img.shields.io/travis/fatih/set.svg?style=flat-square)](https://travis-ci.org/fatih/set)
...
```bash
go get github.com/icha-senpai/note/third_party/forks/github/fatih/set
```
...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/github/fatih/set"
)
