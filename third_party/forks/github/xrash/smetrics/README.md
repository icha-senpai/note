...
```go
import "github.com/icha-senpai/note/third_party/forks/github/xrash/smetrics"
```

# Documentation

Go to [https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/xrash/smetrics](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/xrash/smetrics) for complete documentation.
