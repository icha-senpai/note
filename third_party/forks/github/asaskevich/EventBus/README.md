...
Type the following command in your terminal:
	...
	go get github.com/icha-senpai/note/third_party/forks/github/asaskevich/EventBus
...
```go
import (
	evbus "github.com/icha-senpai/note/third_party/forks/github/asaskevich/EventBus"
)
```
...
#### Notes
Documentation is available here: [godoc.org](https://godoc.org/github.com/icha-senpai/note/third_party/forks/github/asaskevich/EventBus).
Full information about code coverage is also available here: [EventBus on gocover.io](http://gocover.io/github.com/icha-senpai/note/third_party/forks/github/asaskevich/EventBus).

#### Support
If you do have a contribution for the package feel free to put up a Pull Request or open Issue.

#### Special thanks to [contributors](https://github.com/icha-senpai/note/third_party/forks/github/asaskevich/EventBus/graphs/contributors)
