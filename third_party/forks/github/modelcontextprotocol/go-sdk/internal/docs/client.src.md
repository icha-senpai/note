...
[`Client.AddRoots`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#Client.AddRoots)
and
[`Client.RemoveRoots`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#Client.RemoveRoots)
...
[`ServerSession.ListRoots`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#ServerSession.ListRoots)
method. To receive notifications about root changes, set
[`ServerOptions.RootsListChangedHandler`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#ServerOptions.RootsListChangedHandler).
...
[`ClientOptions.CreateMessageHandler`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#ClientOptions.CreateMessageHandler).
This function is invoked whenever the server requests sampling.

**Server-side**: To use sampling from the server, call
[`ServerSession.CreateMessage`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#ServerSession.CreateMessage).
...
[`ClientOptions.ElicitationHandler`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#ClientOptions.ElicitationHandler).
...
[`ServerSession.Elicit`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#ServerSession.Elicit).
...
documentation](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#ClientCapabilities)
...
[`ClientOptions.Capabilities`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/mcp#ClientOptions.Capabilities).
