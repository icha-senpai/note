...
```
go get github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk
```
...
The [`examples/`](https://github.com/icha-senpai/note/third_party/forks/github/modelcontextprotocol/go-sdk/tree/main/examples) directory contains more example clients and
servers.
