...
* [github.com/icha-senpai/note/third_party/forks/github/hhrutter/tiff](https://github.com/icha-senpai/note/third_party/forks/github/hhrutter/tiff) uses this package to extend [x/image/tiff](https://github.com/golang/image/tree/master/tiff).
* [pdfcpu](https://github.com/icha-senpai/note/third_party/forks/pdfcpu) uses this package for processing PDFs with embedded TIFF images.
