...
//
//	go build -ldflags "-X github.com/icha-senpai/note/third_party/forks/external/google.golang.org/protobuf/reflect/protoregistry.conflictPolicy=warn"
//
...
// Several well-known types were hosted in the github.com/icha-senpai/note/third_party/forks/external/google.golang.org/genproto module
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	var prevPath string
	const prevModule = "github.com/icha-senpai/note/third_party/forks/external/google.golang.org/genproto"
	...
	currPath := "github.com/icha-senpai/note/third_party/forks/external/google.golang.org/protobuf/types/known/" + pkgName
	panic(fmt.Sprintf(""+
