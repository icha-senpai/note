...
package xsrftoken // import "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/xsrftoken"
...
// clean sanitizes a string for inclusion in a token by replacing _ with __ and : with _c.
