...
const printerType = "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/message.Printer"
...
func (r *rewriter) Visit(n ast.Node) ast.Visitor {
	...
	// "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/message".Printer.
...
var rewriteFuncs = map[string]map[string]rewriteType{
	// TODO: Printer -> *github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/message.Printer
	"fmt": {
