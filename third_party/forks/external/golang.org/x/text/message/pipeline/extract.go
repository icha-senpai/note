...
import (
	...
	fmtparser "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/internal/format"
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/loader"
...
func (x *extracter) seedEndpoints() error {
	pkgInfo := x.iprog.Package("github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/message")
	if pkgInfo == nil {
		return errors.New("pipeline: github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/message is not imported")
	}
