...
func main() {
	...
	printf("import (\n")
	printf("\t\"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/encoding\"\n")
	printf("\t\"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/encoding/internal/identifier\"\n")
	printf(")\n\n")
