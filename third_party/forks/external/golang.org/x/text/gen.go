...
`
	...
	copyExported("github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/idna")
...
func copyExported(p string) {
	copyPackage(
		...
		"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text/internal/export/"+path.Base(p),
		p)
}
...
func copyPackage(dirSrc, dirDst, search, replace string) {
	err := filepath.Walk(dirSrc, func(file string, info os.FileInfo, err error) error {
		...
		comment := "// Code generated by running \"go generate\" in github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text. DO NOT EDIT.\n\n"
