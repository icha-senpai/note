...
why the gopls application depends on the cmp package:
	...
	$ go list -f '{{.ImportPath}} {{join .Imports " "}}' -deps github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/gopls |
		digraph somepath github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/gopls github.com/icha-senpai/note/third_party/forks/github/google/go-cmp/cmp

Show which packages in x/tools depend, perhaps indirectly, on the callgraph package:

	$ go list -f '{{.ImportPath}} {{join .Imports " "}}' -deps github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/... |
		digraph reverse github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/callgraph
