...
var (
	repo = flag.String("repo", detectrepo(), "Which go repo you want to contribute to. Use \"go\" for the core, or e.g. \"net\" for github.com/icha-senpai/note/third_party/forks/external/golang.org/x/net/*")
