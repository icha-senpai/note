...
package main // import "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/cmd/callgraph"
...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/callgraph"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/callgraph/cha"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/callgraph/rta"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/callgraph/static"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/callgraph/vta"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/packages"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/ssa"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/ssa/ssautil"
)
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/cmd/digraph.
           ...
           github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/ssa for more detail.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/cmd/callgraph |
      digraph succs github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/cmd/callgraph.main
`
