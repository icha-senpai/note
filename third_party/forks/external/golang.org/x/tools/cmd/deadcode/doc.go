...
Example: show all dead code within the gopls module:
	...
	$ deadcode -test github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/gopls/...
...
by package:
	...
	github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/gopls/internal/lsp
		openClientEditor

	github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/gopls/internal/template
		Parsed.WriteNode
		wrNode.writeNode
...
call graph queries, use github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/cmd/callgraph.)
...
is static or dynamic, and its source line number. For example:
	...
	$ deadcode -whylive=bytes.Buffer.String -test ./cmd/deadcode/...
	                 github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/cmd/deadcode.main
	static@L0117 --> github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/packages.Load
	static@L0262 --> github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/packages.defaultDriver
	static@L0305 --> github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/packages.goListDriver
	static@L0153 --> github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/packages.goListDriver$1
	static@L0154 --> github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/internal/packagesdriver.GetSizesForArgsGolist
