...
// To install gonew:
//
//	go install github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/cmd/gonew@latest
//
...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/internal/edit"
)

func usage() {
	fmt.Fprintf(os.Stderr, "usage: gonew srcmod[@version] [dstmod [dir]]\n")
	fmt.Fprintf(os.Stderr, "See https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/cmd/gonew.\n")
	os.Exit(2)
}
