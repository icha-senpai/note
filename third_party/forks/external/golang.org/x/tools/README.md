...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools)

This repository provides the `github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools` module, comprising
...
[`github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/gopls`](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/gopls)
...
```
go install github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/cmd/goimports@latest
```
...
github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/benchmark/parse
github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/ast/astutil
github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/types/typeutil
github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/playground
github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/present
github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/refactor/importgraph
github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/refactor/rename
github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/refactor/satisfy
github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/txtar
