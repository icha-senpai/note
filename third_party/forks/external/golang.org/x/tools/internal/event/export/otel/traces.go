...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/internal/event/keys"
)
	...
	req := otlpTraceExportRequest{
		ResourceSpans: []otlpResourceSpans{{
			...
			ScopeSpans: []otlpScopeSpans{{
				Scope: otlpScope{Name: "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools"},
				Spans: spans,
			}},
		}},
	}
