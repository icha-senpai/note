...
// NeedsLocalXTools skips t if the github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools module is replaced and
...
func NeedsLocalXTools(t testing.TB) {
	...
	cmd := Command(t, "go", "list", "-f", "{{with .Replace}}{{.Dir}}{{end}}", "-m", "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools")
	out, err := cmd.Output()
	if err != nil {
	...
	if want := "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools"; modulePath != want {
