...
// how to use github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/packages to load, parse,
...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/internal/drivertest"
)
