...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/gcexportdata"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/internal/gocommand"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/internal/packagesinternal"
...
func (ld *loader) loadFromExportData(lpkg *loaderPackage) error {
	...
	if viewLen != len(view) {
		log.Panicf("github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/packages: unexpected new packages during load of %s", lpkg.PkgPath)
	}
