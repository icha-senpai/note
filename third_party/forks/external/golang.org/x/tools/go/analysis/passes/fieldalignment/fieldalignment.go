...
gopls. Use this standalone command to run it on your code:
   ...
   $ go install github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/analysis/passes/fieldalignment/cmd/fieldalignment@latest
...
var Analyzer = &analysis.Analyzer{
	Name:     "fieldalignment",
	Doc:      Doc,
	URL:      "https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/analysis/passes/fieldalignment",
