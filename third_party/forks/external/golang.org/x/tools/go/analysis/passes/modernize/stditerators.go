...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/internal/stdlib"
...
var StdIteratorsAnalyzer = &analysis.Analyzer{
	...
	Run: stditerators,
	URL: "https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/analysis/passes/modernize#stditerators",
}
