...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/internal/fmtstr"
...
var FmtAppendfAnalyzer = &analysis.Analyzer{
	...
	Run: fmtappendf,
	URL: "https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/analysis/passes/modernize#fmtappendf",
}
