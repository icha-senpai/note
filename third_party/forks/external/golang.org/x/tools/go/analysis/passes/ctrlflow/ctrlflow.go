...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/cfg"
...
var Analyzer = &analysis.Analyzer{
	...
	URL:        "https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/analysis/passes/ctrlflow",
	Run:        run,
...
func knownIntrinsic(fn *types.Func) (noreturn, known bool) {
	...
	if typesinternal.IsFunctionNamed(fn, "syscall", "Exit", "ExitProcess", "ExitThread") ||
		...
		typesinternal.IsMethodNamed(fn, "github.com/icha-senpai/note/third_party/forks/github/sirupsen/logrus", "Logger", "Exit", "Panic", "Panicf", "Panicln") ||
		typesinternal.IsMethodNamed(fn, "github.com/icha-senpai/note/third_party/forks/github/sirupsen/logrus", "Entry", "Panicf", "Panicln") ||
