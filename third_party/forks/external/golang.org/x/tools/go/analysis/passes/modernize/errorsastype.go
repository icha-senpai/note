...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/internal/versions"
)

var ErrorsAsTypeAnalyzer = &analysis.Analyzer{
	Name:     "errorsastype",
	Doc:      analyzerutil.MustExtractDoc(doc, "errorsastype"),
	URL:      "https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/analysis/passes/modernize#errorsastype",
