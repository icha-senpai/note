...
var Analyzer = &analysis.Analyzer{
	...
	URL:      "https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/analysis/passes/loopclosure",
...
//	g.Go(func() error { ... })
//
// Currently only "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sync/errgroup.Group()" is considered.
func goInvoke(info *types.Info, call *ast.CallExpr) ast.Expr {
	if !isMethodCall(info, call, "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/sync/errgroup", "Group", "Go") {
		return nil
	}
	return call.Args[0]
}
