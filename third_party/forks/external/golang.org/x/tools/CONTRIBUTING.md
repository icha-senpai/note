...
(`github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools`) and the `gopls` module
(`github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/gopls`).
