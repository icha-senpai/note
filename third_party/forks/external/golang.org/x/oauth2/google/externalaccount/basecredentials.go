...
The [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/oauth2.TokenSource] created from the config using [NewTokenSource] can then be used to access Google
Cloud resources. For instance, you can create a new client from the
[github.com/icha-senpai/note/third_party/forks/external/cloud.google.com/go/storage] package and pass in option.WithTokenSource(yourTokenSource))
...
The [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/oauth2.TokenSource] created from the config using [NewTokenSource] can then be used access Google
Cloud resources. For instance, you can create a new client from the
[github.com/icha-senpai/note/third_party/forks/external/cloud.google.com/go/storage] package and pass in option.WithTokenSource(yourTokenSource))
...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/oauth2/google/internal/impersonate"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/oauth2/google/internal/stsexchange"
)
