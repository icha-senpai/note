...
// provider's backend.
//
// This type is a mirror of [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/oauth2.Token] and exists to break
// an otherwise-circular dependency. Other internal packages
// should convert this Token into an [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/oauth2.Token] before use.
type Token struct {
...
// AuthStyle is a copy of the github.com/icha-senpai/note/third_party/forks/external/golang.org/x/oauth2 package's AuthStyle type.
type AuthStyle int
