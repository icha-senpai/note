...
func init() {
	...
	for _, m := range info.Deps {
		if m.Path != "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/crypto" {
			continue
		}
		if m.Replace == nil {
...
func (c *Client) userAgent() string {
	ua := "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/crypto/acme"
	if packageVersion != "" {
		ua += "@" + packageVersion
	}
	if c.UserAgent != "" {
