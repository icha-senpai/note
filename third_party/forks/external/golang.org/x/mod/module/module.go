...
type Version struct {
	// Path is a module path, like "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/text" or "rsc.io/quote/v2".
	Path string
...
func CheckPathMajor(v, pathMajor string) error {
	...
	if strings.HasPrefix(v, "v0.0.0-") && pathMajor == ".v1" {
		...
		// For example, github.com/icha-senpai/note/third_party/forks/external/gopkg.in/yaml.v2@v2.2.1's go.mod requires github.com/icha-senpai/note/third_party/forks/external/gopkg.in/check.v1 v0.0.0-20161208181325-20d25e280405.
		return nil
	}
	m := semver.Major(v)
	if pathMajor == "" {
