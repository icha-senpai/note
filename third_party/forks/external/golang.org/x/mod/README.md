...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod)
...
should remain in [x/tools](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools),
specifically [x/tools/go/packages](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/golang.org/x/tools/go/packages).
