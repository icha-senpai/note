...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/sumdb/note"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/sumdb/tlog"
)

// NewTestServer constructs a new [TestServer]
// that will sign its tree with the given signer key
// (see [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/sumdb/note])
