...
// The module path must be valid (see [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/module.CheckPath]).
// The version must be valid and canonical (see
// [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/module.CanonicalVersion]). The path must have a major
// version suffix consistent with the version (see
// [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/module.Check]). The part of the file path after the
// "<module>@<version>/" prefix must be valid (see
// [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/module.CheckFilePath]).
//
...
// [github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/sumdb/dirhash].
package zip
...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/modfile"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mod/module"
)
