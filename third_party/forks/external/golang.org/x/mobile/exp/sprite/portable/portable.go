...
import (
	...
	xdraw "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/image/draw"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/image/math/f64"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/event/size"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/exp/f32"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/exp/sprite"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/exp/sprite/clock"
)
...
func affine(dst *image.RGBA, src image.Image, srcb image.Rectangle, mask image.Image, a *f32.Affine, op draw.Op) {
	...
	// to src-space. The github.com/icha-senpai/note/third_party/forks/external/golang.org/x/image/draw package's matrices transform
