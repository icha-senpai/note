...
func helpDocumentation(path string) {
	...
	w.WriteString("*/\npackage main // import \"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/cmd/gomobile\"\n")
...
To install:
	...
	$ go install github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/cmd/gomobile@latest
	$ gomobile init
