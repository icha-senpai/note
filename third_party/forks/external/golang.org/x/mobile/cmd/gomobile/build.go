...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/internal/sdkpath"
...
func runBuildImpl(cmd *command) (*packages.Package, error) {
	...
	if !nmpkgs["github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/app"] {
		return nil, fmt.Errorf(`%s does not import "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/app"`, pkg.PkgPath)
	}
...
func extractPkgs(nm string, path string) (map[string]bool, error) {
	if buildN {
		return map[string]bool{"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/app": true}, nil
	}
	r, w := io.Pipe()
