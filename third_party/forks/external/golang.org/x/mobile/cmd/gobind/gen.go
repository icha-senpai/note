...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/bind"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/internal/importers"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/internal/importers/java"
	"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/internal/importers/objc"
...
func genPkg(lang string, p *types.Package, astFiles []*ast.File, allPkg []*types.Package, classes []*java.Class, otypes []*objc.Named) {
	...
	case "java":
		...
		if p == nil {
			dir, err := packageDir("github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/bind")
			if err != nil {
				errorf(`"github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/bind" is not found; run go get github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/bind: %v`, err)
				return
			}
			repo := filepath.Clean(filepath.Join(dir, "..")) // github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile directory.
			...
			javaDir, err := packageDir("github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/bind/java")
			if err != nil {
				errorf("unable to import bind/java: %v", err)
				return
			}
	...
	case "objc":
		...
		if p == nil {
			// Copy support files
			dir, err := packageDir("github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/bind/objc")
			if err != nil {
