...
tool, see https://github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/cmd/gomobile.
...
Examples can be found in http://github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/example.
