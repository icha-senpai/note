...
//
// See the github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/app package for details on the event model.
package size
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/geom package.
	//
