...
import (
	...
	_ "github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/internal/mobileinit"
)
...
type App interface {
	...
	//  - size.Event
	//  - touch.Event
	// from the github.com/icha-senpai/note/third_party/forks/external/golang.org/x/mobile/event/etc packages. Other packages may
