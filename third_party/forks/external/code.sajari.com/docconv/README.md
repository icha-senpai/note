...
[![Go reference](https://pkg.go.dev/badge/github.com/icha-senpai/note/third_party/forks/external/code.sajari.com/docconv.svg)](https://pkg.go.dev/github.com/icha-senpai/note/third_party/forks/external/code.sajari.com/docconv)
...
[![Report card](https://goreportcard.com/badge/github.com/icha-senpai/note/third_party/forks/external/code.sajari.com/docconv)](https://goreportcard.com/report/github.com/icha-senpai/note/third_party/forks/external/code.sajari.com/docconv)
...
> **Note for returning users:** the Go import path for this package changed to `github.com/icha-senpai/note/third_party/forks/external/code.sajari.com/docconv`.
...
To fetch and build the code:
    ...
    $ go install github.com/icha-senpai/note/third_party/forks/external/code.sajari.com/docconv/docd@latest
...
tidy, wv, popplerutils, unrtf, https://github.com/icha-senpai/note/third_party/forks/github/JalfResi/justext

Example install of dependencies (not all systems):

    $ sudo apt-get install poppler-utils wv unrtf tidy
    $ go get github.com/icha-senpai/note/third_party/forks/github/JalfResi/justext
...
Now you can add `-tags ocr` to any `go` command when building/fetching/testing `docconv` to include support for processing images:
    ...
    $ go get -tags ocr github.com/icha-senpai/note/third_party/forks/external/code.sajari.com/docconv/...
...
import (
	...
	"github.com/icha-senpai/note/third_party/forks/external/code.sajari.com/docconv/client"
)
