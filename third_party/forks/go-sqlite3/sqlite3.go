...
// go build -ldflags="-X 'github.com/icha-senpai/note/third_party/forks/go-sqlite3.driverName=my-sqlite3'"
...
func (c *SQLiteConn) exec(ctx context.Context, query string, args []driver.NamedValue) (driver.Result, error) {
	...
	for {
		...
		if tail == "" {
			if res == nil {
				// https://github.com/icha-senpai/note/third_party/forks/go-sqlite3/issues/963
