...
* Supports disabling Markdown `*` and `_` syntax input
* Browser clipping extension supports path selection
* Add a template function `getHPathByID`
...
* Upgrade to Electron v30.5.1

### Development

* Add plugin event `opened-notebook` & `closed-notebook`
