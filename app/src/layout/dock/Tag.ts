...
export class Tag extends Model {
    ...
    <div class="block__logo fn__flex-1">${window.scribli.languages.tag}</div>
    ...
    <span data-type="sort" class="block__icon ariaLabel${window.scribli.config.readonly ? " fn__none" : ""}" data-position="north" aria-label="${window.scribli.languages.sort}">
...
<div class="fn__flex-1" style="margin-bottom: 8px"></div>`;
        ...
        this.tree = new Tree({
            ...
            click(element: HTMLElement, event?: MouseEvent) {
                ...
                openGlobalSearch(app, `#${element.getAttribute("data-label")}#`, !window.scribli.ctrlIsPressed, {method: 0});
            },
