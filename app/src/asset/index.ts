...
export class Asset extends Model {
    ...
    private render(isInit = true) {
        ...
        } else if (Constants.SCRIBLI_ASSETS_AUDIO.includes(type)) {
      ...
      <div id="sidebarContainer">
        <div id="toolbarSidebar">
          <div id="toolbarSidebarLeft">
              <button id="viewThumbnail" class="toolbarButton toggled b3-tooltips b3-tooltips__ne" aria-label="${window.scribli.languages.thumbsTitle}">
                <svg><use xlink:href="#iconImage"></use></svg>
              </button>
              <button id="viewOutline" class="toolbarButton b3-tooltips b3-tooltips__ne" aria-label="${window.scribli.languages.outline}">
          ...
          <div id="toolbarSidebarRight">
            <div id="outlineOptionsContainer" class="fn__hidden">
              <button id="currentOutlineItem" class="toolbarButton b3-tooltips b3-tooltips__nw" disabled="disabled" aria-label="${window.scribli.languages.focusOutline}">
      ...
      <div id="mainContainer">
        <div class="findbar b3-menu fn__hidden doorHanger" id="findbar">
            <input id="findInput" class="toolbarField b3-text-field" placeholder="${window.scribli.languages.search}">
            <div class="fn__space"></div>
            <button id="findPreviousButton" class="toolbarButton findPrevious b3-tooltips b3-tooltips__n" aria-label="${window.scribli.languages.previous}">
                <svg><use xlink:href="#iconUp"></use></svg>
            </button>
            <button id="findNextButton" class="toolbarButton findNext b3-tooltips b3-tooltips__n" aria-label="${window.scribli.languages.next}">
                <svg><use xlink:href="#iconDown"></use></svg>
            </button>
            <label class="b3-button b3-button--outline b3-button--small">
                <input type="checkbox" id="findHighlightAll" class="toolbarField">
                ${window.scribli.languages.findHighlight}
            </label>
            <div class="fn__space"></div>
            <label class="b3-button b3-button--outline b3-button--small">
                <input type="checkbox" id="findMatchCase" class="toolbarField">
                ${window.scribli.languages.searchCaseSensitive}
            </label>
            <div class="fn__space"></div>
            <label class="b3-button b3-button--outline b3-button--small">
                <input type="checkbox" id="findMatchDiacritics" class="toolbarField">
                ${window.scribli.languages.matchDiacritics}
            </label>
            <div class="fn__space"></div>
            <label class="b3-button b3-button--outline b3-button--small">
                <input type="checkbox" id="findEntireWord" class="toolbarField">
                ${window.scribli.languages.findEntireWord}
            </label>
            <div class="fn__space"></div>
        ...
        <div id="secondaryToolbar" class="secondaryToolbar fn__hidden doorHangerRight b3-menu">
          <div id="secondaryToolbarButtonContainer" class="b3-menu__items">
            <button id="pdfLight" class="secondaryToolbarButton b3-menu__item toggled">
              ...
              <span class="b3-menu__label">${window.scribli.languages.themeLight}</span>
            </button>
            <button id="pdfDark" class="secondaryToolbarButton b3-menu__item">
              <svg class="b3-menu__icon"><use xlink:href="#iconDark"></use></svg> 
              <span class="b3-menu__label">${window.scribli.languages.themeDark}</span>
            </button>
            ...
            <button id="previous" class="secondaryToolbarButton b3-menu__item pageUp">
              ...
              <span class="b3-menu__label">${window.scribli.languages.previousLabel}</span>
            ...
            <button id="next" class="secondaryToolbarButton b3-menu__item pageDown">
              ...
              <span class="b3-menu__label">${window.scribli.languages.nextLabel}</span>
            ...
            <button id="firstPage" class="secondaryToolbarButton b3-menu__item firstPage">
              ...
              <span class="b3-menu__label">${window.scribli.languages.firstPage}</span>
            ...
            <button id="lastPage" class="secondaryToolbarButton b3-menu__item lastPage">
              ...
              <span class="b3-menu__label">${window.scribli.languages.lastPage}</span>
            ...
            <button id="zoomOutButton" class="secondaryToolbarButton b3-menu__item zoomOut">
               ...
               <span class="b3-menu__label">${window.scribli.languages.zoomOut}</span>
            ...
            <button id="zoomInButton" class="secondaryToolbarButton b3-menu__item zoomIn">
               ...
               <span class="b3-menu__label">${window.scribli.languages.zoomIn}</span>
               <span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip("⌘=")}</span>
            </button>
            <button id="pageRotateCw" class="secondaryToolbarButton b3-menu__item rotateCw">
               ...
               <span class="b3-menu__label">${window.scribli.languages.rotateCw}</span>
            ...
            <button id="pageRotateCcw" class="secondaryToolbarButton b3-menu__item rotateCcw">
               ...
               <span class="b3-menu__label">${window.scribli.languages.rotateCcw}</span>
            ...
            <button id="cursorSelectTool" class="secondaryToolbarButton b3-menu__item selectTool toggled">
               ...
               <span class="b3-menu__label">${window.scribli.languages.cursorText}</span>
            ...
            <button id="cursorHandTool" class="secondaryToolbarButton b3-menu__item handTool">
              ...
              <span class="b3-menu__label">${window.scribli.languages.cursorHand}</span>
            ...
            <button id="scrollVertical" class="secondaryToolbarButton b3-menu__item scrollModeButtons scrollVertical toggled">
             <svg class="b3-menu__icon"><use xlink:href="#iconScrollVert"></use></svg> 
              <span class="b3-menu__label">${window.scribli.languages.scrollVertical}</span>
            </button>
            <button id="scrollHorizontal" class="secondaryToolbarButton b3-menu__item scrollModeButtons scrollHorizontal">
              ...
              <span class="b3-menu__label">${window.scribli.languages.scrollHorizontal}</span>
            </button>
            <button id="scrollWrapped" class="secondaryToolbarButton b3-menu__item scrollModeButtons scrollWrapped">
             <svg class="b3-menu__icon"><use xlink:href="#iconScrollWrapped"></use></svg> 
              <span class="b3-menu__label">${window.scribli.languages.scrollWrapped}</span>
            </button>
            ...
            <button id="spreadNone" class="secondaryToolbarButton b3-menu__item spreadModeButtons spreadNone toggled">
              ...
              <span class="b3-menu__label">${window.scribli.languages.spreadNone}</span>
            </button>
            <button id="spreadOdd" class="secondaryToolbarButton b3-menu__item spreadModeButtons spreadOdd">
              ...
              <span class="b3-menu__label">${window.scribli.languages.spreadOdd}</span>
            </button>
            <button id="spreadEven" class="secondaryToolbarButton b3-menu__item spreadModeButtons spreadEven">
              ...
              <span class="b3-menu__label">${window.scribli.languages.spreadEven}</span>
            </button>
            <button id="presentationMode" class="secondaryToolbarButton b3-menu__item presentationMode">
              ...
              <span class="b3-menu__label">${window.scribli.languages.presentationMode}</span>
            ...
            <button id="documentProperties" class="secondaryToolbarButton b3-menu__item documentProperties">
              ...
              <span class="b3-menu__label">${window.scribli.languages.attr}</span>
            </button>
          </div>
        ...
        <div class="pdf__toolbar">
          <div id="toolbarContainer">
            <div id="toolbarViewer">
                <button id="sidebarToggleButton" class="toolbarButton b3-tooltips b3-tooltips__se" aria-expanded="false" aria-controls="sidebarContainer" aria-label="${window.scribli.languages.toggleSidebarNotification2Title} ${updateHotkeyTip("F4")}">
                    <svg><use xlink:href="#iconLayoutLeft"></use></svg>
                </button>
                <button id="viewFindButton" class="toolbarButton b3-tooltips b3-tooltips__se" aria-expanded="false" aria-controls="findbar" aria-label="${window.scribli.languages.search} ${updateHotkeyTip("⌘F")}">
                  <svg><use xlink:href="#iconSearch"></use></svg>
                </button>
                <button id="rectAnno" class="toolbarButton b3-tooltips b3-tooltips__se" aria-expanded="false" aria-controls="findbar" aria-label="${window.scribli.languages.rectAnnotation} ${updateHotkeyTip("⌘D")}/${updateHotkeyTip("⌥D")}">
                ...
                <span id="scaleSelectContainer" class="dropdownToolbarButton">
                  <select id="scaleSelect" class="b3-select">
                    <option id="pageAutoOption" value="auto" selected="selected">${window.scribli.languages.pageScaleAuto}</option>
                    <option id="pageActualOption" value="page-actual">${window.scribli.languages.pageScaleActual}</option>
                    <option id="pageFitOption" value="page-fit">${window.scribli.languages.pageScaleFit}</option>
                    <option id="pageWidthOption" value="page-width">${window.scribli.languages.pageScaleWidth}</option>
                ...
                <button id="secondaryToolbarToggleButton" class="toolbarButton b3-tooltips b3-tooltips__sw" aria-label="${window.scribli.languages.more}" aria-expanded="false" aria-controls="secondaryToolbar">
      ...
      <div id="dialogContainer">
        ...
        <div class="dialog" id="documentPropertiesDialog">
            <div class="row">
              <span>${window.scribli.languages.fileName}</span> <p id="fileNameField">-</p>
            </div>
            <div class="row">
              <span>${window.scribli.languages.fileSize}</span> <p id="fileSizeField">-</p>
            </div>
            <div class="separator"></div>
            <div class="row">
              <span>${window.scribli.languages.title1}</span> <p id="titleField">-</p>
            </div>
            <div class="row">
              <span>${window.scribli.languages.author}</span> <p id="authorField">-</p>
            </div>
            <div class="row">
              <span>${window.scribli.languages.subject}</span> <p id="subjectField">-</p>
            </div>
            <div class="row">
              <span>${window.scribli.languages.keywords}</span> <p id="keywordsField">-</p>
            </div>
            <div class="row">
              <span>${window.scribli.languages.creationDate}</span> <p id="creationDateField">-</p>
            </div>
            <div class="row">
              <span>${window.scribli.languages.modificationDate}</span> <p id="modificationDateField">-</p>
            </div>
            <div class="row">
              <span>${window.scribli.languages.creator}</span> <p id="creatorField">-</p>
            </div>
            <div class="separator"></div>
            <div class="row">
              <span>PDF ${window.scribli.languages.producer}</span> <p id="producerField">-</p>
            </div>
            <div class="row">
              <span>PDF ${window.scribli.languages.version}</span> <p id="versionField">-</p>
            </div>
            <div class="row">
              <span>${window.scribli.languages.pageCount}</span> <p id="pageCountField">-</p>
            </div>
            <div class="row">
              <span>${window.scribli.languages.pageSize}</span> <p id="pageSizeField">-</p>
            </div>
            <div class="separator"></div>
            <div class="row">
              <span>${window.scribli.languages.linearized}</span> <p id="linearizedField">-</p>
            </div>
            <div class="buttonRow">
              <button id="documentPropertiesClose" class="b3-button"><span>${window.scribli.languages.close}</span></button>
            </div>
        </div>
      ...
      <div class="pdf__util b3-menu fn__none pdf__util--hide">
        ...
        <button class="b3-menu__item pdf__util__hide" data-type="toggle">
            ...
            <span class="b3-menu__label">${window.scribli.languages.showHideBg}</span>
        </button>
        <button class="b3-menu__item pdf__util__hide" data-type="copy">
            <svg class="b3-menu__icon"><use xlink:href="#iconRef"></use></svg>
            <span class="b3-menu__label">${window.scribli.languages.copyAnnotation}</span>
        </button>
        ...
        <button class="b3-menu__item pdf__util__hide" data-type="remove">
            ...
            <span class="b3-menu__label">${window.scribli.languages.remove}</span>
        </button>
      </div>
      <div class="fn__none">
    ...
    <div id="printContainer"></div>`;
            const localPDF = window.scribli.storage[Constants.LOCAL_PDFTHEME];
            const pdfTheme = window.scribli.config.appearance.mode === 0 ? localPDF.light : localPDF.dark;
            ...
            lightElement.addEventListener("click", () => {
                if (window.scribli.config.appearance.mode === 0) {
