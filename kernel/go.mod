module github.com/icha-senpai/note/kernel
...
require (
	...
	github.com/icha-senpai/note/third_party/forks v0.0.0
...
replace github.com/icha-senpai/note/third_party/forks => ../third_party/forks
